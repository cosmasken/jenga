...
/**
 * @title FakeDAI
 * @dev Fake DAI token for testing purposes on Citrea testnet
 * @notice This is a test token with 18 decimals like real DAI
 */
contract FakeDAI is ERC20, Ownable {
    mapping(address => uint256) public lastFaucetClaim;
    uint256 public constant FAUCET_AMOUNT = 1000; // 1000 DAI per claim
    uint256 public constant FAUCET_COOLDOWN = 24 hours; // 24 hour cooldown
    
    constructor() ERC20("Fake Dai Stablecoin", "fDAI") Ownable(msg.sender) {
        // Mint initial supply to deployer (1 million DAI)
    ...
    function faucet() external {
        ...
        _mint(msg.sender, FAUCET_AMOUNT * 10**18);
    }
