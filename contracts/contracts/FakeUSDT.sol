...
/**
 * @title FakeUSDT
 * @dev Fake USDT token for testing purposes on Citrea testnet
 * @notice This is a test token with 6 decimals like real USDT
 */
contract FakeUSDT is ERC20, Ownable {
    uint8 private _decimals = 6;
    mapping(address => uint256) public lastFaucetClaim;
    uint256 public constant FAUCET_AMOUNT = 1000; // 1000 USDT per claim
    uint256 public constant FAUCET_COOLDOWN = 24 hours; // 24 hour cooldown
    
    constructor() ERC20("Fake Tether USD", "fUSDT") Ownable(msg.sender) {
